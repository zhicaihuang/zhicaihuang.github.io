...
[[3]](https://arxiv.org/abs/1612.00837) Making the V in VQA Matter: Elevating the Role of Image Understanding in Visual Question Answering, D Parikh (CVPR2017)  
[[4]](https://arxiv.org/abs/1610.01465v4)  Visual Question Answering: Datasets, Algorithms, and Future Challenges , C Kanan  
[[5]](https://arxiv.org/abs/1903.00366)  Answer Them All! Toward Universal Visual Question Answering Models, C Kanan  
[[6]](http://de.arxiv.org/pdf/1410.0210) A Multi-World Approach to Question Answering about Real-World Scenes based on Uncertain Input,M Malinowski,NIPS2014    
[[7]](http://openaccess.thecvf.com/content_cvpr_2016/papers/Kafle_Answer-Type_Prediction_for_CVPR_2016_paper.pdf) Answer-Type Prediction for Visual Question Answering    
[[8]](https://arxiv.org/abs/1706.03762) Attention Is All You Need, google  
[[9]](http://export.arxiv.org/abs/1606.03647) Training Recurrent Answering Units with Joint Loss Minimization for VQA    
[[10]](https://arxiv.org/abs/1506.00278v1) Visual Madlibs: Fill in the blank Image Generation and Question Answering    
[[11]](https://arxiv.org/abs/1703.09684v2) An analysis of visual question answering algorithms ,C Kanan  
[[12]](https://arxiv.org/abs/1607.05910) Visual Question Answering: A Survey of Methods and Datasets,Q Wu    
[[13]](https://arxiv.org/abs/1904.02794) VQD: Visual Query Detection in Natural Scenes, C Kanan  
[[14]](https://arxiv.org/abs/1411.4555) Show and Tell: A Neural Image Caption Generator    
[[15]](http://vision.cs.unc.edu/home/publications/babytalk_pami.pdf) Baby Talk: Understanding and Generating Simple Image Descriptions, pami   
[[16]](https://arxiv.org/abs/1511.02274) Stacked attention networks for image question answering   
[[17]](https://arxiv.org/abs/1603.01417) Dynamic Memory Networks for Visual and Textual Question Answering    
[[18]](https://arxiv.org/abs/1612.06890) CLEVR: A Diagnostic Dataset for Compositional Language and Elementary Visual Reasoning, Feifei Li    
[[19]](https://arxiv.org/abs/1505.05612) Are You Talking to a Machine? Dataset and Methods for Multilingual Image Question Answering, Baidu NIPS    
[[20]](https://arxiv.org/abs/1908.07490) LXMERT: Learning Cross-Modality Encoder Representations from Transformers, EMNLP 2019   
[[21]](https://arxiv.org/abs/1906.10770) Deep Modular Co-Attention Networks for Visual Question Answering, CVPR 2019, Jun Yu     
[[22]](https://arxiv.org/abs/1512.02167) Simple Baseline for Visual Question Answering   
[[23]](https://arxiv.org/abs/1511.06973) Ask Me Anything: Free-form Visual Question Answering Based on Knowledge from External Sources    
[[24]](https://arxiv.org/abs/1603.02814) Image Captioning and Visual Question Answering Based on Attributes and External Knowledge    
[[25]](https://arxiv.org/abs/1612.05386) The VQA-Machine: Learning How to Use Existing Vision Algorithms to Answer New Questions    
[[26]](https://arxiv.org/abs/1711.07613) Are You Talking to Me? Reasoned Visual Dialog Generation through Adversarial Learning, CVPR 2017    
[[27]](https://arxiv.org/abs/1511.02570) Explicit Knowledge-based Reasoning for Visual Question Answering    
[[28]](https://arxiv.org/abs/1606.07356) Analyzing the Behavior of Visual Question Answering Models, EMNLP 2016, D Parikh    
[[29]](https://arxiv.org/abs/1511.02799v2)Deep Compositional Question Answering with Neural Module Networks   
[[30]](https://arxiv.org/abs/1506.07285) Ask Me Anything: Dynamic Memory Networks for Natural Language Processing    
[[31]](https://arxiv.org/abs/1606.01847) Multimodal Compact Bilinear Pooling for Visual Question Answering and Visual Grounding,EMNLP 2016    
[[32]](https://arxiv.org/abs/1604.01485) A Focused Dynamic Attention Model for Visual Question Answering    
[[33]](https://arxiv.org/abs/1606.01455) Multimodal Residual Learning for Visual QA    
[[34]](https://arxiv.org/abs/1610.04325) Hadamard Product for Low-rank Bilinear Pooling    
[[35]](https://arxiv.org/abs/1708.01471) Multi-modal Factorized Bilinear Pooling with Co-Attention Learning for Visual Question Answering,ICCV 2017    
[[36]](https://arxiv.org/abs/1712.00377) Don't Just Assume; Look and Answer: Overcoming Priors for Visual Question Answering,D Parikh,CVPR18    
[[37]](https://arxiv.org/abs/1806.07243) Learning Conditioned Graph Structures for Interpretable Visual Question Answering,NIPS 2018, AimBrain    
[[38]](https://arxiv.org/abs/1902.09774) Image-Question-Answer Synergistic Network for Visual Dialog, CVPR 2019    
[[39]](https://arxiv.org/abs/1511.05234) Ask, Attend and Answer: Exploring Question-Guided Spatial Attention for Visual Question Answering,ECCV2015   
[[40]](https://arxiv.org/abs/1109.6841) Learning Dependency-Based Compositional Semantics     
[[41]](https://arxiv.org/abs/1705.09406) Multimodal Machine Learning: A Survey and Taxonomy     
[[42]](https://arxiv.org/abs/1708.03619) Beyond Bilinear: Generalized Multimodal Factorized High-order Pooling for Visual Question Answering, TNNLS 2015    
[[43]](https://arxiv.org/abs/1611.05109v1) Low-rank Bilinear Pooling for Fine-Grained Classification     
[[44]](https://arxiv.org/abs/1409.0473) Neural Machine Translation by Jointly Learning to Align and Translate    
[[45]](http://www.microsoft.com/en-us/research/wp-content/uploads/2017/06/Multi-level-Attention-Networks-for-Visual-Question-Answering.pdf) Multi-level attention networks for visual question answering     
[[46]](https://arxiv.org/abs/1708.02071) Structured attentions for visual question answering   
[[47]](https://arxiv.org/abs/1606.00061) Hierarchical question-image co-attention for visual question answering, NIPS2016     
[[48]](https://arxiv.org/abs/1803.09845) Neural Baby Talk </a> a method of image captioning.    
[[49]](https://arxiv.org/abs/1605.02697) Ask Your Neurons: A Neural-based Approach to Answering Questions about Images, ICCV15   
[[50]](https://arxiv.org/abs/1809.03707) Answering Visual What-If Questions: From Actions to Predicted Scene Descriptions,ECCV18   
[[51]](https://arxiv.org/abs/1703.03939) Ask Me Even More: Dynamic Memory Tensor Networks (Extended Model)    
[[52]](https://arxiv.org/abs/1804.00775) Improved fusion of visual and language representations by dense symmetric co-attention for visual question answering, CVPR18    
[[53]](https://arxiv.org/abs/1805.07932) Bilinear attention networks, NIPS18  
